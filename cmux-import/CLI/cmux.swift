...
struct CMUXCLI {
    ...
    private func subcommandUsage(_ command: String) -> String? {
        ...
        case "split-off":
            ...
            Move a surface into a new split in the given direction without changing focus by default.
        ...
        case "browser":
            ...
            Subcommands:
              open|open-split|new [url] [--workspace <id|ref|index>] [--window <id|ref|index>] [--focus <true|false>]
                open/open-split/new default to $CMUX_WORKSPACE_ID when --workspace is omitted and --window is not set; focus defaults to false
        ...
        case "markdown":
            ...
            Options:
              ...
              --window <id|ref|index>      Target window
              --direction <left|right|up|down>  Split direction (default: right)
              --focus <true|false>          Focus the markdown surface (default: false)
...
"""#
    ...
    private func usage() -> String {
        ...
        Commands:
          ...
          browser open-split [url] [--focus <true|false>]
