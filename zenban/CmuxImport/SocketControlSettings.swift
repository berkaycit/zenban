...
enum SocketControlMode: String, CaseIterable, Identifiable {
    ...
    var displayName: String {
        ...
        case .cmuxOnly:
            return String(localized: "socketControl.cmuxOnly.name", defaultValue: "Zenban processes only")
        case .automation:
    ...
    var description: String {
        ...
        case .cmuxOnly:
            return String(localized: "socketControl.cmuxOnly.description", defaultValue: "Only processes started inside Zenban terminals can send commands.")
        case .automation:
